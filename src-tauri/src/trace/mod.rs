//! LLM call tracing — persists every ChatModel HTTP request/response to the
...
pub use sink::{
    DbTraceSink, LlmTrace, NullTraceSink, TraceSink, optional_shared, redact_secrets, truncate,
};
